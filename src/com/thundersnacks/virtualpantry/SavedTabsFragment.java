...
public class SavedTabsFragment extends Fragment {
    ...
    public class SavedTabsListAdapter extends BaseExpandableListAdapter {
        ...
        public View getGroupView(int groupPosition, boolean isExpanded,
            ...
            if (convertView == null) {
                LayoutInflater infalInflater = (LayoutInflater) SavedTabsFragment.this.getActivity()
        ...
        public View getChildView(final int groupPosition, final int childPosition,
            ...
            LayoutInflater inflater = SavedTabsFragment.this.getActivity().getLayoutInflater();
            ...
            convertView.setOnClickListener(new OnClickListener() {
            	public void onClick(View v) {
            		final Dialog viewDialog = new Dialog(SavedTabsFragment.this.getActivity());
            ...
            edit.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                	final Dialog editDialog = new Dialog(SavedTabsFragment.this.getActivity());
